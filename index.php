...
<p>
<strong lat="49.81" lon="18.26" zoom="10" text="Ostrava">
Ostrava</strong> je tady
</p>
...
$mysqli = new mysqli('127.0.0.1', 'root', 'root', 'mat0305');
	...
	*/
	...
	for ($i=0; $i<count($pieces); $i++) {
		...
		if (in_array($word, $ostrava)) {
			...
			$vyber++;
			$pieces[$i] = "<strong id=\"".$vyber."\">".$pieces[$i]."</strong>";
		}
	}
